...
$_['text_pagination'] = 'Hiển thị% d đến% d của% d (% d Pages)';
...
$_['error_upload_1'] = 'Cảnh báo: tệp đã tải lên vượt quá chỉ thị upload_max_filesize trong php.ini';
$_['error_upload_2'] = 'Cảnh báo: tệp đã tải lên vượt quá chỉ thị MAX_FILE_SIZE đã được chỉ định trong biểu mẫu HTML!';
$_['error_upload_3'] = 'Cảnh báo: Tập tin tải lên chỉ được tải lên một phần!';
$_['error_upload_4'] = 'Cảnh báo: Không có tập tin đã được tải lên!';
$_['error_upload_6'] = 'Cảnh báo: Thiếu một thư mục tạm!';
$_['error_upload_7'] = 'Cảnh báo: Không thể ghi tập tin vào đĩa!';
$_['error_upload_8'] = 'Cảnh báo: Tải lên tập tin bị dừng lại bởi phần mở rộng!';
$_['error_upload_999'] = 'Cảnh báo: không có mã lỗi nào!';
